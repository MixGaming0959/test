...
/** @type {string} */
const CACHE_VERSION = '1731520798|1645158897';
/** @type {string} */
const CACHE_PREFIX = '142 Game-sw-cache-';
...
/** @type {string[]} */
const CACHABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgdsqlite.web.template_release.wasm32.wasm"];
